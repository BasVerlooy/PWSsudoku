...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>5. Seamless interoperation with the DOM &#8212; Transcrypt 3.6.82 documentation</title>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="c1"># Free after the example from the Python 3.5 manual</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">turtle</span> <span class="k">import</span> <span class="o">*</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">__pragma__</span> <span class="p">(</span><span class="s1">&#39;skip&#39;</span><span class="p">)</span>
...
<h2>6.1. Three ways of integration with JavaScript libraries<a class="headerlink" href="#three-ways-of-integration-with-javascript-libraries" title="Permalink to this headline">¶</a></h2>
...
<span id="code-encaps-fabric"></span><div class="code-block-caption"><span class="caption-text">The encapsulation layer for fabric.js</span><a class="headerlink" href="#id4" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">__pragma__</span> <span class="p">(</span><span class="s1">&#39;noanno&#39;</span><span class="p">)</span>
...
<span class="sd">    &#39;&#39;&#39;</span><span class="p">,</span>
    <span class="n">__include__</span> <span class="p">(</span><span class="s1">&#39;com/fabricjs/__javascript__/fabric.js&#39;</span><span class="p">)</span>
<span class="p">)</span>
</pre></div>
</div>
</div>
<p>Note that __pragma__ ('js', &lt;skeletoncode&gt;, includes = [&lt;file1&gt;, &lt;file2&gt;, ..]) is used to achieve the encapsulation. It replaces the {} by the respective contents of the files. The <em>fabric</em> module is part of the download. Note that not all facilities were included in customizing fabric.js. You can drop-in replace the <em>fabric.js</em> in the __javascript__ subdirectory by another customized version without changing anything. Preferably download a development version, since that enables easy debugging. Transcryp will minify it for you on the fly.</p>
</div>
<div class="section" id="example-pong">
<h2>6.2. Example: Pong<a class="headerlink" href="#example-pong" title="Permalink to this headline">¶</a></h2>
...
<tbody valign="top">
<tr class="row-odd"><td><div class="literal-block-wrapper first last docutils container" id="id5">
<div class="code-block-caption"><span class="caption-text">pong.py</span><a class="headerlink" href="#id5" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">__pragma__</span> <span class="p">(</span><span class="s1">&#39;skip&#39;</span><span class="p">)</span>
...
<td><div class="literal-block-wrapper first last docutils container" id="id6">
<div class="code-block-caption"><span class="caption-text">pong.mod.js</span><a class="headerlink" href="#id6" title="Permalink to this code">¶</a></div>
...
<h2>6.4. Example: jQuery<a class="headerlink" href="#example-jquery" title="Permalink to this headline">¶</a></h2>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">__pragma__</span> <span class="p">(</span><span class="s1">&#39;alias&#39;</span><span class="p">,</span> <span class="s1">&#39;S&#39;</span><span class="p">,</span> <span class="s1">&#39;$&#39;</span><span class="p">)</span>
...
<div class="code-block-caption"><span class="caption-text">jquery_demo.mod.js</span><a class="headerlink" href="#id8" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span>    (function () {
        var __name__ = &#39;__main__&#39;;
        var start = function () {
...
<h2>6.5. Example: iOS web app with native look and feel<a class="headerlink" href="#example-ios-web-app-with-native-look-and-feel" title="Permalink to this headline">¶</a></h2>
...
<div class="highlight-default"><div class="highlight"><pre><span></span>&lt;html manifest=&quot;cache.manifest&quot;&gt;
    &lt;!-- v45 --&gt;
    &lt;head&gt;
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">CACHE</span> <span class="n">MANIFEST</span>
...
<h2>6.6. Example: D3.js<a class="headerlink" href="#example-d3-js" title="Permalink to this headline">¶</a></h2>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">class</span> <span class="nc">Spawn</span><span class="p">:</span>
...
<div class="code-block-caption"><span class="caption-text">d3js_demo.mod.js</span><a class="headerlink" href="#id13" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span>    <span class="p">(</span><span class="n">function</span> <span class="p">()</span> <span class="p">{</span>
        <span class="n">var</span> <span class="vm">__name__</span> <span class="o">=</span> <span class="s1">&#39;__main__&#39;</span><span class="p">;</span>
        <span class="n">var</span> <span class="n">Spawn</span> <span class="o">=</span> <span class="vm">__class__</span> <span class="p">(</span><span class="s1">&#39;Spawn&#39;</span><span class="p">,</span> <span class="p">[</span><span class="nb">object</span><span class="p">],</span> <span class="p">{</span>
            ...
            <span class="n">get</span> <span class="fm">__init__</span> <span class="p">()</span> <span class="p">{</span><span class="k">return</span> <span class="fm">__get__</span> <span class="p">(</span><span class="n">this</span><span class="p">,</span> <span class="n">function</span> <span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">width</span><span class="p">,</span> <span class="n">height</span><span class="p">)</span> <span class="p">{</span>
                ...
                <span class="bp">self</span><span class="o">.</span><span class="n">force</span> <span class="o">=</span> <span class="n">d3</span><span class="o">.</span><span class="n">layout</span><span class="o">.</span><span class="n">force</span> <span class="p">()</span><span class="o">.</span><span class="n">size</span> <span class="p">(</span><span class="nb">list</span> <span class="p">([</span><span class="bp">self</span><span class="o">.</span><span class="n">width</span><span class="p">,</span> <span class="bp">self</span><span class="o">.</span><span class="n">height</span><span class="p">]))</span><span class="o">.</span><span class="n">nodes</span> <span class="p">(</span><span class="nb">list</span> <span class="p">([</span><span class="nb">dict</span> <span class="p">({})]))</span><span class="o">.</span><span class="n">linkDistance</span> <span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">spacing</span><span class="p">)</span><span class="o">.</span><span class="n">charge</span> <span class="p">(</span><span class="o">-</span><span class="p">(</span><span class="mi">1000</span><span class="p">))</span><span class="o">.</span><span class="n">on</span> <span class="p">(</span><span class="s1">&#39;tick&#39;</span><span class="p">,</span> <span class="bp">self</span><span class="o">.</span><span class="n">tick</span><span class="p">);</span>
            ...
            <span class="p">});}</span>
        <span class="p">});</span>
        <span class="n">var</span> <span class="n">spawn</span> <span class="o">=</span> <span class="n">Spawn</span> <span class="p">(</span><span class="n">window</span><span class="o">.</span><span class="n">innerWidth</span><span class="p">,</span> <span class="n">window</span><span class="o">.</span><span class="n">innerHeight</span><span class="p">);</span>
        <span class="n">__pragma__</span> <span class="p">(</span><span class="s1">&#39;&lt;all&gt;&#39;</span><span class="p">)</span>
            <span class="n">__all__</span><span class="o">.</span><span class="n">Spawn</span> <span class="o">=</span> <span class="n">Spawn</span><span class="p">;</span>
            <span class="n">__all__</span><span class="o">.</span><span class="vm">__name__</span> <span class="o">=</span> <span class="vm">__name__</span><span class="p">;</span>
            <span class="n">__all__</span><span class="o">.</span><span class="n">spawn</span> <span class="o">=</span> <span class="n">spawn</span><span class="p">;</span>
        <span class="n">__pragma__</span> <span class="p">(</span><span class="s1">&#39;&lt;/all&gt;&#39;</span><span class="p">)</span>
...
<h2>6.7. Example: React<a class="headerlink" href="#example-react" title="Permalink to this headline">¶</a></h2>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="c1"># Helper functions</span>
...
<div class="code-block-caption"><span class="caption-text">react_demo.mod.js</span><a class="headerlink" href="#id15" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span>    <span class="p">(</span><span class="n">function</span> <span class="p">()</span> <span class="p">{</span>
        <span class="n">var</span> <span class="vm">__name__</span> <span class="o">=</span> <span class="s1">&#39;__main__&#39;</span><span class="p">;</span>
        <span class="n">var</span> <span class="n">h</span> <span class="o">=</span> <span class="n">function</span> <span class="p">(</span><span class="n">elm_type</span><span class="p">,</span> <span class="n">props</span><span class="p">)</span> <span class="p">{</span>
            ...
            <span class="k">return</span> <span class="n">React</span><span class="o">.</span><span class="n">createElement</span> <span class="p">(</span><span class="n">elm_type</span><span class="p">,</span> <span class="n">props</span><span class="p">,</span> <span class="o">...</span><span class="n">args</span><span class="p">);</span>
        <span class="p">};</span>
        <span class="n">var</span> <span class="n">render</span> <span class="o">=</span> <span class="n">function</span> <span class="p">(</span><span class="n">react_element</span><span class="p">,</span> <span class="n">destination_id</span><span class="p">,</span> <span class="n">callback</span><span class="p">)</span> <span class="p">{</span>
        ...
        <span class="p">})}));</span>
        <span class="n">var</span> <span class="n">element</span> <span class="o">=</span> <span class="n">React</span><span class="o">.</span><span class="n">createElement</span> <span class="p">(</span><span class="n">Hello</span><span class="p">,</span> <span class="nb">dict</span> <span class="p">({</span><span class="s1">&#39;name&#39;</span><span class="p">:</span> <span class="s1">&#39;React!&#39;</span><span class="p">}));</span>
        <span class="n">render</span> <span class="p">(</span><span class="n">element</span><span class="p">,</span> <span class="s1">&#39;container&#39;</span><span class="p">);</span>
        <span class="n">__pragma__</span> <span class="p">(</span><span class="s1">&#39;&lt;all&gt;&#39;</span><span class="p">)</span>
            <span class="n">__all__</span><span class="o">.</span><span class="n">Hello</span> <span class="o">=</span> <span class="n">Hello</span><span class="p">;</span>
            <span class="n">__all__</span><span class="o">.</span><span class="vm">__name__</span> <span class="o">=</span> <span class="vm">__name__</span><span class="p">;</span>
            <span class="n">__all__</span><span class="o">.</span><span class="n">element</span> <span class="o">=</span> <span class="n">element</span><span class="p">;</span>
            <span class="n">__all__</span><span class="o">.</span><span class="n">h</span> <span class="o">=</span> <span class="n">h</span><span class="p">;</span>
            <span class="n">__all__</span><span class="o">.</span><span class="n">render</span> <span class="o">=</span> <span class="n">render</span><span class="p">;</span>
        <span class="n">__pragma__</span> <span class="p">(</span><span class="s1">&#39;&lt;/all&gt;&#39;</span><span class="p">)</span>
    <span class="p">})</span> <span class="p">();</span>
</pre></div>
</div>
...
<h2>6.8. Example: Riot<a class="headerlink" href="#example-riot" title="Permalink to this headline">¶</a></h2>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="o">//</span> <span class="n">vim</span><span class="p">:</span> <span class="n">ft</span><span class="o">=</span><span class="n">html</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="c1"># Parent Class for a Transcrypt Riot Tag</span>
<span class="c1">#</span>
...
<div class="code-block-caption"><span class="caption-text">riot_tag.mod.js, compiled by Transcrypt</span><a class="headerlink" href="#id20" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span>    __nest__ (
        __all__,
        &#39;riot_tag&#39;, {
            __all__: {
                __inited__: false,
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="c1"># an example user tag, using RiotTag</span>
...
<div class="code-block-caption"><span class="caption-text">riot_demo.mod.js, compiled by Transcrypt</span><a class="headerlink" href="#id22" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span>    <span class="p">(</span><span class="n">function</span> <span class="p">()</span> <span class="p">{</span>
        <span class="n">var</span> <span class="vm">__name__</span> <span class="o">=</span> <span class="s1">&#39;__main__&#39;</span><span class="p">;</span>
        <span class="n">var</span> <span class="n">RiotTag</span> <span class="o">=</span> <span class="fm">__init__</span> <span class="p">(</span><span class="n">__world__</span><span class="o">.</span><span class="n">riot_tag</span><span class="p">)</span><span class="o">.</span><span class="n">RiotTag</span><span class="p">;</span>
        <span class="n">var</span> <span class="n">P</span> <span class="o">=</span> <span class="vm">__class__</span> <span class="p">(</span><span class="s1">&#39;P&#39;</span><span class="p">,</span> <span class="p">[</span><span class="n">RiotTag</span><span class="p">],</span> <span class="p">{</span>
            <span class="vm">__module__</span><span class="p">:</span> <span class="vm">__name__</span><span class="p">,</span>
            <span class="n">debug</span><span class="p">:</span> <span class="mi">1</span><span class="p">,</span>
            <span class="n">lv</span><span class="p">:</span> <span class="nb">list</span> <span class="p">([</span><span class="nb">dict</span> <span class="p">({</span><span class="s1">&#39;name&#39;</span><span class="p">:</span> <span class="s1">&#39;n0&#39;</span><span class="p">})]),</span>
            ...
            <span class="p">});}</span>
        <span class="p">});</span>
        <span class="n">var</span> <span class="n">Sample2</span> <span class="o">=</span> <span class="vm">__class__</span> <span class="p">(</span><span class="s1">&#39;Sample2&#39;</span><span class="p">,</span> <span class="p">[</span><span class="n">P</span><span class="p">],</span> <span class="p">{</span>
            <span class="vm">__module__</span><span class="p">:</span> <span class="vm">__name__</span><span class="p">,</span>
            ...
            <span class="p">});}</span>
        <span class="p">});</span>
        <span class="n">__pragma__</span> <span class="p">(</span><span class="s1">&#39;&lt;use&gt;&#39;</span> <span class="o">+</span>
            <span class="s1">&#39;riot_tag&#39;</span> <span class="o">+</span>
        <span class="s1">&#39;&lt;/use&gt;&#39;</span><span class="p">)</span>
        <span class="n">__pragma__</span> <span class="p">(</span><span class="s1">&#39;&lt;all&gt;&#39;</span><span class="p">)</span>
            <span class="n">__all__</span><span class="o">.</span><span class="n">P</span> <span class="o">=</span> <span class="n">P</span><span class="p">;</span>
            <span class="n">__all__</span><span class="o">.</span><span class="n">RiotTag</span> <span class="o">=</span> <span class="n">RiotTag</span><span class="p">;</span>
            <span class="n">__all__</span><span class="o">.</span><span class="n">Sample2</span> <span class="o">=</span> <span class="n">Sample2</span><span class="p">;</span>
            <span class="n">__all__</span><span class="o">.</span><span class="vm">__name__</span> <span class="o">=</span> <span class="vm">__name__</span><span class="p">;</span>
        <span class="n">__pragma__</span> <span class="p">(</span><span class="s1">&#39;&lt;/all&gt;&#39;</span><span class="p">)</span>
    <span class="p">})</span> <span class="p">();</span>
</pre></div>
...
<h2>6.9. Example: Using input and print in a DOM __terminal__ element in your browser<a class="headerlink" href="#example-using-input-and-print-in-a-dom-terminal-element-in-your-browser" title="Permalink to this headline">¶</a></h2>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="o">&lt;</span><span class="n">html</span><span class="o">&gt;</span>
    <span class="o">&lt;</span><span class="n">head</span><span class="o">&gt;</span>
        <span class="o">&lt;</span><span class="n">script</span> <span class="n">src</span><span class="o">=</span><span class="s2">&quot;__javascript__/terminal_demo.js&quot;</span><span class="o">&gt;&lt;/</span><span class="n">script</span><span class="o">&gt;</span>
    <span class="o">&lt;/</span><span class="n">head</span><span class="o">&gt;</span>
    <span class="o">&lt;</span><span class="n">body</span><span class="o">&gt;</span>
        <span class="n">Refresh</span> <span class="n">browser</span> <span class="n">window</span> <span class="n">to</span> <span class="n">restart</span>
    <span class="o">&lt;/</span><span class="n">body</span><span class="o">&gt;</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">while</span> <span class="kc">True</span><span class="p">:</span>
    <span class="n">name</span> <span class="o">=</span> <span class="nb">input</span> <span class="p">(</span><span class="s1">&#39;What&#39;&#39;s your name? (leave blank to quit)&#39;</span><span class="p">)</span>
    ...
    <span class="k">if</span> <span class="n">age</span> <span class="o">&lt;</span> <span class="mi">18</span><span class="p">:</span>
        <span class="nb">print</span> <span class="p">(</span><span class="s1">&#39;Sorry&#39;</span><span class="p">,</span> <span class="n">name</span><span class="p">,</span> <span class="s1">&#39;,&#39;</span><span class="p">,</span> <span class="n">age</span><span class="p">,</span> <span class="s1">&#39;is to young to drive a car in the Netherlands.&#39;</span><span class="p">)</span>
    <span class="k">else</span><span class="p">:</span>
...
<li><a class="reference internal" href="#three-ways-of-integration-with-javascript-libraries">6.1. Three ways of integration with JavaScript libraries</a></li>
<li><a class="reference internal" href="#example-pong">6.2. Example: Pong</a></li>
<li><a class="reference internal" href="#joined-minification">6.3. Joined minification</a></li>
<li><a class="reference internal" href="#example-jquery">6.4. Example: jQuery</a></li>
<li><a class="reference internal" href="#example-ios-web-app-with-native-look-and-feel">6.5. Example: iOS web app with native look and feel</a></li>
<li><a class="reference internal" href="#example-d3-js">6.6. Example: D3.js</a></li>
<li><a class="reference internal" href="#example-react">6.7. Example: React</a></li>
<li><a class="reference internal" href="#example-riot">6.8. Example: Riot</a></li>
<li><a class="reference internal" href="#example-using-input-and-print-in-a-dom-terminal-element-in-your-browser">6.9. Example: Using input and print in a DOM __terminal__ element in your browser</a></li>
</ul>
</li>
</ul>
