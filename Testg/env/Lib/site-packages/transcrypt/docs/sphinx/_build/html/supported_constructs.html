...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>4. Systematic code examples: a guided tour of Transcrypt &#8212; Transcrypt 3.6.82 documentation</title>
  ...
  <body>
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-0"><a href="index.html">Transcrypt 3.6.82 documentation</a> &#187;</li> 
      </ul>
    </div>  
...
<span class="c1"># __pragma__ (&#39;ifdef&#39;, &#39;__py3.6__&#39;) # Needed because Transcrypt imports are compile time</span>
<span class="k">if</span> <span class="s1">&#39;__py3.6__&#39;</span> <span class="ow">in</span> <span class="n">__symbols__</span><span class="p">:</span>      <span class="c1"># Needed because CPython doesn&#39;t understand pragma&#39;s</span>
    <span class="kn">import</span> <span class="nn">dashed_numbers</span>
<span class="c1"># __pragma__ (&#39;endif&#39;)</span>
...
<span class="c1"># __pragma__ (&#39;ifdef&#39;, &#39;__esv6__&#39;)</span>
<span class="k">if</span> <span class="s1">&#39;__esv6__&#39;</span> <span class="ow">in</span> <span class="n">__symbols__</span><span class="p">:</span>
...
<span class="c1"># __pragma__ (&#39;ifdef&#39;, &#39;__py3.6__&#39;)</span>
<span class="k">if</span> <span class="s1">&#39;__py3.6__&#39;</span> <span class="ow">in</span> <span class="n">__symbols__</span><span class="p">:</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">org.transcrypt.stubs.browser</span> <span class="k">import</span> <span class="n">__pragma__</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">def</span> <span class="nf">run</span> <span class="p">(</span><span class="n">autoTester</span><span class="p">):</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="c1"># Callable built-in method unit tests</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">def</span> <span class="nf">run</span> <span class="p">(</span><span class="n">autoTester</span><span class="p">):</span>
    ...
    <span class="n">autoTester</span><span class="o">.</span><span class="n">check</span> <span class="p">(</span><span class="s1">&#39;&lt;br&gt;&lt;br&gt;Augmented isinstance&lt;br&gt;&#39;</span><span class="p">)</span>
    ...
    <span class="n">tupleTypes</span> <span class="o">=</span> <span class="p">((</span><span class="nb">dict</span><span class="p">,</span> <span class="nb">list</span><span class="p">),</span> <span class="p">(</span><span class="nb">bool</span><span class="p">,</span> <span class="nb">int</span><span class="p">),</span> <span class="p">(</span><span class="nb">bool</span><span class="p">,</span> <span class="n">A</span><span class="p">),</span> <span class="p">(</span><span class="n">C</span><span class="p">,</span> <span class="n">B</span><span class="p">))</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">def</span> <span class="nf">f</span> <span class="p">(</span><span class="n">x</span><span class="p">,</span> <span class="n">b</span><span class="p">):</span>
...
<h2>4.10. Data structures: tuple, list, dict, set<a class="headerlink" href="#data-structures-tuple-list-dict-set" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id11">
<div class="code-block-caption"><span class="caption-text">Testlet: data_structures</span><a class="headerlink" href="#id11" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">def</span> <span class="nf">run</span> <span class="p">(</span><span class="n">autoTester</span><span class="p">):</span>
...
<h2>4.11. Decorators: function and class, with and without parameters<a class="headerlink" href="#decorators-function-and-class-with-and-without-parameters" title="Permalink to this headline">¶</a></h2>
...
<div class="code-block-caption"><span class="caption-text">Testlet: decorators</span><a class="headerlink" href="#id12" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">org.transcrypt.stubs.browser</span> <span class="k">import</span> <span class="n">__pragma__</span>
...
<h2>4.12. Dict comprehensions<a class="headerlink" href="#dict-comprehensions" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id13">
<div class="code-block-caption"><span class="caption-text">Testlet: dict_comprehensions</span><a class="headerlink" href="#id13" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">org.transcrypt.stubs.browser</span> <span class="k">import</span> <span class="n">__pragma__</span>
...
<h2>4.13. Dictionaries: dict revisited<a class="headerlink" href="#dictionaries-dict-revisited" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id14">
<div class="code-block-caption"><span class="caption-text">Testlet: dictionaries</span><a class="headerlink" href="#id14" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">org.transcrypt.stubs.browser</span> <span class="k">import</span> <span class="n">__pragma__</span>
...
<span id="autotest-docstrings"></span><h2>4.14. Diverse issues<a class="headerlink" href="#diverse-issues" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id15">
<div class="code-block-caption"><span class="caption-text">Testlet: div_issues</span><a class="headerlink" href="#id15" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">org.transcrypt.stubs.browser</span> <span class="k">import</span> <span class="n">__pragma__</span><span class="p">,</span> <span class="fm">__new__</span><span class="p">,</span> <span class="n">__envir__</span><span class="p">,</span> <span class="n">__symbols__</span>
...
<span class="k">def</span> <span class="nf">run</span> <span class="p">(</span><span class="n">autoTester</span><span class="p">):</span>
    ...
    <span class="k">try</span><span class="p">:</span>
        ...
        <span class="c1"># Since JavaScript 5 gives no exception for a loop over a non-iterable, following code must only be executed for JavaScript 6</span>
        <span class="c1"># Since Transcrypt doesn&#39;t get to see all modules loaded by CPython, __ifdef__ cannot be made to do its thing for all modules in an efficient way for CPython</span>
        <span class="c1"># But a normal &#39;if&#39; will work</span>
        <span class="k">if</span> <span class="s1">&#39;__esv6__&#39;</span> <span class="ow">in</span> <span class="n">__symbols__</span><span class="p">:</span>
    ...
    <span class="k">if</span> <span class="s1">&#39;__esv6__&#39;</span> <span class="ow">in</span> <span class="n">__symbols__</span><span class="p">:</span>   <span class="c1"># &quot;if&quot; rather than &quot;__pragma__ (&#39;ifdef&#39;)&quot; because CPython doesn&#39;t understand pragma&#39;s</span>
...
<span class="c1">#                   self.pseudoRandom = (1234 * self.pseudoRandom + 57) % 137           # Deliberately short period</span>
    ...
    <span class="c1">#__pragma__ (&#39;ifdef&#39;, &#39;__esv6__&#39;)   # Needed because Transcrypt imports are compile time</span>
    <span class="k">if</span> <span class="s1">&#39;__esv6__&#39;</span> <span class="ow">in</span> <span class="n">__symbols__</span><span class="p">:</span>      <span class="c1"># Needed because CPython doesn&#39;t understand pragma&#39;s</span>
...
<h2>4.15. Diverse pulls<a class="headerlink" href="#diverse-pulls" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id16">
<div class="code-block-caption"><span class="caption-text">Testlet: div_pulls</span><a class="headerlink" href="#id16" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="c1"># Also contains small enhancements</span>
...
<h2>4.16. Docstrings: __doc__ attribute generated optionally<a class="headerlink" href="#docstrings-doc-attribute-generated-optionally" title="Permalink to this headline">¶</a></h2>
...
<div class="code-block-caption"><span class="caption-text">Testlet: docstrings</span><a class="headerlink" href="#id17" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="sd">&#39;&#39;&#39;Just a module</span>
...
<h2>4.17. Exceptions: exception class hierarchy, finally<a class="headerlink" href="#exceptions-exception-class-hierarchy-finally" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id18">
<div class="code-block-caption"><span class="caption-text">Testlet: exceptions</span><a class="headerlink" href="#id18" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">org.transcrypt.stubs.browser</span> <span class="k">import</span> <span class="n">__envir__</span><span class="p">,</span> <span class="fm">__new__</span><span class="p">,</span> <span class="n">__pragma__</span>
...
<span class="k">if</span> <span class="n">__envir__</span><span class="o">.</span><span class="n">executor_name</span> <span class="o">==</span> <span class="n">__envir__</span><span class="o">.</span><span class="n">transpiler_name</span><span class="p">:</span>
    <span class="k">class</span> <span class="nc">BaseException</span><span class="p">:</span>        <span class="c1"># ??? Make part of __builtins__ for CPython compliance?</span>
        <span class="k">pass</span>
...
<h2>4.18. Extended slices: facilitating NumScrypt and such<a class="headerlink" href="#extended-slices-facilitating-numscrypt-and-such" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id19">
<div class="code-block-caption"><span class="caption-text">Testlet: extended_slices</span><a class="headerlink" href="#id19" title="Permalink to this code">¶</a></div>
...
<h2>4.19. General functions: sort and sorted<a class="headerlink" href="#general-functions-sort-and-sorted" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id20">
<div class="code-block-caption"><span class="caption-text">Testlet: general_functions</span><a class="headerlink" href="#id20" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">org.transcrypt.stubs.browser</span> <span class="k">import</span> <span class="n">__pragma__</span>
...
<span class="k">def</span> <span class="nf">run</span> <span class="p">(</span><span class="n">autoTester</span><span class="p">):</span>
    ...
    <span class="n">__pragma__</span> <span class="p">(</span><span class="s1">&#39;ifdef&#39;</span><span class="p">,</span> <span class="s1">&#39;__esv6__&#39;</span><span class="p">)</span>
    <span class="k">if</span> <span class="s1">&#39;__esv6__&#39;</span> <span class="ow">in</span> <span class="n">autoTester</span><span class="o">.</span><span class="n">symbols</span><span class="p">:</span>    
...
<h2>4.20. Global variable access by using globals () [&lt;variable_name&gt;]<a class="headerlink" href="#global-variable-access-by-using-globals-variable-name" title="Permalink to this headline">¶</a></h2>
...
<div class="code-block-caption"><span class="caption-text">Testlet: globals_function, module sub</span><a class="headerlink" href="#id21" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">xxa</span> <span class="o">=</span> <span class="s1">&#39;subXxa&#39;</span>
...
<div class="code-block-caption"><span class="caption-text">Testlet: globals_function, main program</span><a class="headerlink" href="#id22" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">globals_function</span> <span class="k">import</span> <span class="n">sub</span>
...
<h2>4.21. Indices and slices: LHS, RHS, basic and extended<a class="headerlink" href="#indices-and-slices-lhs-rhs-basic-and-extended" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id23">
<div class="code-block-caption"><span class="caption-text">Testlet: indices_and_slices</span><a class="headerlink" href="#id23" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">def</span> <span class="nf">run</span> <span class="p">(</span><span class="n">autoTester</span><span class="p">):</span>
...
<h2>4.22. Iterators and generators<a class="headerlink" href="#iterators-and-generators" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id24">
<div class="code-block-caption"><span class="caption-text">Testlet: iterators_and_generators</span><a class="headerlink" href="#id24" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">org.transcrypt.stubs.browser</span> <span class="k">import</span> <span class="n">__pragma__</span>
...
<h2>4.23. Lambda functions with all types of args<a class="headerlink" href="#lambda-functions-with-all-types-of-args" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id25">
<div class="code-block-caption"><span class="caption-text">Testlet: lambda_functions</span><a class="headerlink" href="#id25" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">def</span> <span class="nf">run</span> <span class="p">(</span><span class="n">autoTester</span><span class="p">):</span>
...
<h2>4.24. List comprehensions: multi-loop and nested with multiple if's<a class="headerlink" href="#list-comprehensions-multi-loop-and-nested-with-multiple-if-s" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id26">
<div class="code-block-caption"><span class="caption-text">Testlet: list_comprehensions</span><a class="headerlink" href="#id26" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">def</span> <span class="nf">run</span> <span class="p">(</span><span class="n">autoTester</span><span class="p">):</span>
...
<h2>4.25. Local classes: inside other classes and functions<a class="headerlink" href="#local-classes-inside-other-classes-and-functions" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id27">
<div class="code-block-caption"><span class="caption-text">Testlet: local_classes</span><a class="headerlink" href="#id27" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">def</span> <span class="nf">run</span> <span class="p">(</span><span class="n">autoTester</span><span class="p">):</span>       
    <span class="k">class</span> <span class="nc">A</span><span class="p">:</span>
        <span class="k">class</span> <span class="nc">B</span><span class="p">:</span>
            <span class="k">class</span> <span class="nc">C</span><span class="p">:</span>
...
<h2>4.26. Metaclasses: overriding type.__new__ in a descendant metaclass<a class="headerlink" href="#metaclasses-overriding-type-new-in-a-descendant-metaclass" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id28">
<div class="code-block-caption"><span class="caption-text">Testlet: metaclasses</span><a class="headerlink" href="#id28" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">org.transcrypt.stubs.browser</span> <span class="k">import</span> <span class="n">__pragma__</span>
...
<h2>4.27. Method and class decorators<a class="headerlink" href="#method-and-class-decorators" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id29">
<div class="code-block-caption"><span class="caption-text">Testlet: method_and_class_decorators</span><a class="headerlink" href="#id29" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">org.transcrypt.stubs.browser</span> <span class="k">import</span> <span class="n">__pragma__</span>
...
<h2>4.28. Module builtin: a small part of it demo'ed<a class="headerlink" href="#module-builtin-a-small-part-of-it-demo-ed" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id30">
<div class="code-block-caption"><span class="caption-text">Testlet: module_builtin</span><a class="headerlink" href="#id30" title="Permalink to this code">¶</a></div>
...
<h2>4.29. Module cmath: allmost all of Python's cmath module<a class="headerlink" href="#module-cmath-allmost-all-of-python-s-cmath-module" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id31">
<div class="code-block-caption"><span class="caption-text">Testlet: module_cmath</span><a class="headerlink" href="#id31" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">org.transcrypt.stubs.browser</span> <span class="k">import</span> <span class="n">__pragma__</span>
...
<h2>4.30. Module datetime: transcryption of Python's datetime module<a class="headerlink" href="#module-datetime-transcryption-of-python-s-datetime-module" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id32">
<div class="code-block-caption"><span class="caption-text">Testlet: module_datetime</span><a class="headerlink" href="#id32" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">datetime</span> <span class="k">import</span> <span class="n">date</span><span class="p">,</span> <span class="n">timedelta</span><span class="p">,</span> <span class="n">datetime</span><span class="p">,</span> <span class="n">timezone</span>
...
<h2>4.31. Module itertools: allmost all of Python's itertools module<a class="headerlink" href="#module-itertools-allmost-all-of-python-s-itertools-module" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id33">
<div class="code-block-caption"><span class="caption-text">Testlet: module_itertools</span><a class="headerlink" href="#id33" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">itertools</span> <span class="k">import</span> <span class="o">*</span>
...
<h2>4.32. Module math: allmost all of Python's math module<a class="headerlink" href="#module-math-allmost-all-of-python-s-math-module" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id34">
<div class="code-block-caption"><span class="caption-text">Testlet: module_math</span><a class="headerlink" href="#id34" title="Permalink to this code">¶</a></div>
...
<h2>4.33. Module random: most important functions of Python's random module<a class="headerlink" href="#module-random-most-important-functions-of-python-s-random-module" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id35">
<div class="code-block-caption"><span class="caption-text">Manual_test: module_random</span><a class="headerlink" href="#id35" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">random</span> <span class="k">import</span> <span class="o">*</span>
...
<h2>4.34. Module re: transcryption of Python's re module<a class="headerlink" href="#module-re-transcryption-of-python-s-re-module" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id36">
<div class="code-block-caption"><span class="caption-text">Testlet: re/autotest</span><a class="headerlink" href="#id36" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">import</span> <span class="nn">org.transcrypt.autotester</span>
...
<div class="code-block-caption"><span class="caption-text">Testlet: re/basictests</span><a class="headerlink" href="#id37" title="Permalink to this code">¶</a></div>
...
<span class="sd">    &quot;&quot;&quot;</span>
    <span class="n">__pragma__</span> <span class="p">(</span><span class="s1">&#39;ifdef&#39;</span><span class="p">,</span> <span class="s1">&#39;__esv5__&#39;</span><span class="p">)</span>
    <span class="k">if</span> <span class="p">(</span> <span class="s1">&#39;__esv5__&#39;</span> <span class="ow">in</span> <span class="n">__symbols__</span> <span class="p">):</span>
        <span class="n">test</span><span class="o">.</span><span class="n">check</span><span class="p">(</span><span class="s2">&quot;Skip finditer tests in esv5&quot;</span><span class="p">)</span>
        <span class="k">return</span>
    <span class="n">__pragma__</span><span class="p">(</span><span class="s1">&#39;else&#39;</span><span class="p">)</span>
...
<div class="code-block-caption"><span class="caption-text">Testlet: re/basic_pyre</span><a class="headerlink" href="#id38" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="c1"># File: basic_pyre.py</span>
<span class="c1">#</span>
...
<div class="code-block-caption"><span class="caption-text">Testlet: re/basictests</span><a class="headerlink" href="#id39" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">org.transcrypt.stubs.browser</span> <span class="k">import</span> <span class="n">__pragma__</span>
<span class="kn">import</span> <span class="nn">re</span>
<span class="n">__pragma__</span><span class="p">(</span><span class="s2">&quot;skip&quot;</span><span class="p">)</span>
<span class="n">re</span><span class="o">.</span><span class="n">J</span> <span class="o">=</span> <span class="p">(</span><span class="mi">1</span><span class="o">&lt;&lt;</span><span class="mi">19</span><span class="p">)</span>
...
<h2>4.35. Module time: transcryption of Python's time module<a class="headerlink" href="#module-time-transcryption-of-python-s-time-module" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id40">
<div class="code-block-caption"><span class="caption-text">Testlet: time/testlet0</span><a class="headerlink" href="#id40" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">import</span> <span class="nn">org.transcrypt.autotester</span>
...
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="sd">&#39;&#39;&#39; general functions &#39;&#39;&#39;</span>
...
<span class="k">def</span> <span class="nf">run</span> <span class="p">(</span><span class="n">autoTester</span><span class="p">):</span>
    ...
    <span class="n">c</span><span class="p">(</span><span class="s1">&#39;tzname:&#39;</span>         <span class="p">,</span> <span class="n">time</span><span class="o">.</span><span class="n">tzname</span><span class="p">)</span>
...
<div class="code-block-caption"><span class="caption-text">Testlet: time/mult_time</span><a class="headerlink" href="#id42" title="Permalink to this code">¶</a></div>
...
<div class="code-block-caption"><span class="caption-text">Testlet: time/strptime</span><a class="headerlink" href="#id43" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="sd">&#39;&#39;&#39;</span>
...
<h2>4.36. Modules: hierarchical, both local to the project and global url-based<a class="headerlink" href="#modules-hierarchical-both-local-to-the-project-and-global-url-based" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id44">
<div class="code-block-caption"><span class="caption-text">Testlet: modules</span><a class="headerlink" href="#id44" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">import</span> <span class="nn">modules.mod1.mod11.mod111</span>
...
<span class="k">def</span> <span class="nf">run</span> <span class="p">(</span><span class="n">autoTester</span><span class="p">):</span>
    ...
    <span class="c1"># From ... import within function, with circular import</span>
...
<h2>4.37. Nonlocals<a class="headerlink" href="#nonlocals" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id45">
<div class="code-block-caption"><span class="caption-text">Testlet: nonlocals</span><a class="headerlink" href="#id45" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">def</span> <span class="nf">run</span> <span class="p">(</span><span class="n">autoTester</span><span class="p">):</span>
...
<h2>4.38. Operator overloading<a class="headerlink" href="#operator-overloading" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id46">
<div class="code-block-caption"><span class="caption-text">Testlet: operator_overloading</span><a class="headerlink" href="#id46" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">org.transcrypt.stubs.browser</span> <span class="k">import</span> <span class="n">__pragma__</span>
...
<span id="autotest-properties"></span><h2>4.39. Properties<a class="headerlink" href="#properties" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id47">
<div class="code-block-caption"><span class="caption-text">Testlet: properties</span><a class="headerlink" href="#id47" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">class</span> <span class="nc">A</span><span class="p">:</span>
...
<h2>4.40. Representation as text: the repr and str built-in functions<a class="headerlink" href="#representation-as-text-the-repr-and-str-built-in-functions" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id48">
<div class="code-block-caption"><span class="caption-text">Testlet: reprtest</span><a class="headerlink" href="#id48" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span>
<span class="k">def</span> <span class="nf">run</span><span class="p">(</span><span class="n">test</span><span class="p">):</span>
...
<h2>4.41. Set comprehensions<a class="headerlink" href="#set-comprehensions" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id49">
<div class="code-block-caption"><span class="caption-text">Testlet: set_comprehensions</span><a class="headerlink" href="#id49" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">def</span> <span class="nf">run</span> <span class="p">(</span><span class="n">autoTester</span><span class="p">):</span>
...
<h2>4.42. Super<a class="headerlink" href="#super" title="Permalink to this headline">¶</a></h2>
...
<div class="code-block-caption"><span class="caption-text">Testlet: builtin_super</span><a class="headerlink" href="#id50" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">def</span> <span class="nf">run</span> <span class="p">(</span><span class="n">autoTester</span><span class="p">):</span>
...
<h2>4.43. Simple and augmented assignment<a class="headerlink" href="#simple-and-augmented-assignment" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id51">
<div class="code-block-caption"><span class="caption-text">Testlet: simple_and_augmented_assignment</span><a class="headerlink" href="#id51" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">class</span> <span class="nc">A</span><span class="p">:</span>
    <span class="k">def</span> <span class="nf">__init__</span> <span class="p">(</span><span class="bp">self</span><span class="p">):</span>
...
<h2>4.44. Truthyness: optional Python-style evaluation of truthyness, falsyness and non-empty container selection<a class="headerlink" href="#truthyness-optional-python-style-evaluation-of-truthyness-falsyness-and-non-empty-container-selection" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id52">
<div class="code-block-caption"><span class="caption-text">Testlet: truthyness</span><a class="headerlink" href="#id52" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">org.transcrypt.stubs.browser</span> <span class="k">import</span> <span class="n">__pragma__</span>
...
<h2>4.45. Tuple assignment: recursive and in for-headers using enumerate<a class="headerlink" href="#tuple-assignment-recursive-and-in-for-headers-using-enumerate" title="Permalink to this headline">¶</a></h2>
<div class="literal-block-wrapper docutils container" id="id53">
<div class="code-block-caption"><span class="caption-text">Testlet: tuple_assignment</span><a class="headerlink" href="#id53" title="Permalink to this code">¶</a></div>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="k">def</span> <span class="nf">run</span> <span class="p">(</span><span class="n">autoTester</span><span class="p">):</span>
...
<li><a class="reference internal" href="#data-structures-tuple-list-dict-set">4.10. Data structures: tuple, list, dict, set</a></li>
<li><a class="reference internal" href="#decorators-function-and-class-with-and-without-parameters">4.11. Decorators: function and class, with and without parameters</a></li>
<li><a class="reference internal" href="#dict-comprehensions">4.12. Dict comprehensions</a></li>
<li><a class="reference internal" href="#dictionaries-dict-revisited">4.13. Dictionaries: dict revisited</a></li>
<li><a class="reference internal" href="#diverse-issues">4.14. Diverse issues</a></li>
<li><a class="reference internal" href="#diverse-pulls">4.15. Diverse pulls</a></li>
<li><a class="reference internal" href="#docstrings-doc-attribute-generated-optionally">4.16. Docstrings: __doc__ attribute generated optionally</a></li>
<li><a class="reference internal" href="#exceptions-exception-class-hierarchy-finally">4.17. Exceptions: exception class hierarchy, finally</a></li>
<li><a class="reference internal" href="#extended-slices-facilitating-numscrypt-and-such">4.18. Extended slices: facilitating NumScrypt and such</a></li>
<li><a class="reference internal" href="#general-functions-sort-and-sorted">4.19. General functions: sort and sorted</a></li>
<li><a class="reference internal" href="#global-variable-access-by-using-globals-variable-name">4.20. Global variable access by using globals () [&lt;variable_name&gt;]</a></li>
<li><a class="reference internal" href="#indices-and-slices-lhs-rhs-basic-and-extended">4.21. Indices and slices: LHS, RHS, basic and extended</a></li>
<li><a class="reference internal" href="#iterators-and-generators">4.22. Iterators and generators</a></li>
<li><a class="reference internal" href="#lambda-functions-with-all-types-of-args">4.23. Lambda functions with all types of args</a></li>
<li><a class="reference internal" href="#list-comprehensions-multi-loop-and-nested-with-multiple-if-s">4.24. List comprehensions: multi-loop and nested with multiple if's</a></li>
<li><a class="reference internal" href="#local-classes-inside-other-classes-and-functions">4.25. Local classes: inside other classes and functions</a></li>
<li><a class="reference internal" href="#metaclasses-overriding-type-new-in-a-descendant-metaclass">4.26. Metaclasses: overriding type.__new__ in a descendant metaclass</a></li>
<li><a class="reference internal" href="#method-and-class-decorators">4.27. Method and class decorators</a></li>
<li><a class="reference internal" href="#module-builtin-a-small-part-of-it-demo-ed">4.28. Module builtin: a small part of it demo'ed</a></li>
<li><a class="reference internal" href="#module-cmath-allmost-all-of-python-s-cmath-module">4.29. Module cmath: allmost all of Python's cmath module</a></li>
<li><a class="reference internal" href="#module-datetime-transcryption-of-python-s-datetime-module">4.30. Module datetime: transcryption of Python's datetime module</a></li>
<li><a class="reference internal" href="#module-itertools-allmost-all-of-python-s-itertools-module">4.31. Module itertools: allmost all of Python's itertools module</a></li>
<li><a class="reference internal" href="#module-math-allmost-all-of-python-s-math-module">4.32. Module math: allmost all of Python's math module</a></li>
<li><a class="reference internal" href="#module-random-most-important-functions-of-python-s-random-module">4.33. Module random: most important functions of Python's random module</a></li>
<li><a class="reference internal" href="#module-re-transcryption-of-python-s-re-module">4.34. Module re: transcryption of Python's re module</a></li>
<li><a class="reference internal" href="#module-time-transcryption-of-python-s-time-module">4.35. Module time: transcryption of Python's time module</a></li>
<li><a class="reference internal" href="#modules-hierarchical-both-local-to-the-project-and-global-url-based">4.36. Modules: hierarchical, both local to the project and global url-based</a></li>
<li><a class="reference internal" href="#nonlocals">4.37. Nonlocals</a></li>
<li><a class="reference internal" href="#operator-overloading">4.38. Operator overloading</a></li>
<li><a class="reference internal" href="#properties">4.39. Properties</a></li>
<li><a class="reference internal" href="#representation-as-text-the-repr-and-str-built-in-functions">4.40. Representation as text: the repr and str built-in functions</a></li>
<li><a class="reference internal" href="#set-comprehensions">4.41. Set comprehensions</a></li>
<li><a class="reference internal" href="#super">4.42. Super</a></li>
<li><a class="reference internal" href="#simple-and-augmented-assignment">4.43. Simple and augmented assignment</a></li>
<li><a class="reference internal" href="#truthyness-optional-python-style-evaluation-of-truthyness-falsyness-and-non-empty-container-selection">4.44. Truthyness: optional Python-style evaluation of truthyness, falsyness and non-empty container selection</a></li>
<li><a class="reference internal" href="#tuple-assignment-recursive-and-in-for-headers-using-enumerate">4.45. Tuple assignment: recursive and in for-headers using enumerate</a></li>
</ul>
</li>
</ul>
